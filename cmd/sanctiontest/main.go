...
//
// sanctiontest is not a stable tool. Please contact Moov developers if you intend to use this tool,
...
func main() {
	...
	log.Printf("Starting moov/sanctiontest %s", sanctionsearch.Version)
