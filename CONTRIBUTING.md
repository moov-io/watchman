...
This project uses [Go Modules](https://github.com/golang/go/wiki/Modules) and thus uses Go 1.14 or higher. You can download the source code and we offer [tagged and released versions](https://github.com/moov-io/watchman/releases) as well. We highly recommend you use a tagged release for production.
